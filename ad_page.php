...
<?php echo "<h5 class='col-12'>".$_SESSION[$paid][$_GET["selectedValue"]]->getTitle()."</h5>"?>
	...
	<div id="carou" class="carousel slide" data-ride="carousel" width='100%'>
		...
		<a class="carousel-control-prev bg-dark" href="#carou" data-slide="prev"><span class="carousel-control-prev-icon"></span></a>
		<a class="carousel-control-next bg-dark" href="#carou" data-slide="next"><span class="carousel-control-next-icon"></span></a>
	</div>
